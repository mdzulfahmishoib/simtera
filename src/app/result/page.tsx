...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Header />
      <main className="flex-1 flex items-start lg:items-center justify-center px-4 md:px-6 pt-24 md:pb-8 pb-8">
        <div className="container mx-auto grid lg:grid-cols-12 gap-4 items-start">

          {/* Result Card */}
          <div className="lg:col-span-7 w-full order-1">
            <Card className="relative w-full shadow-md border-none overflow-hidden text-center">
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full">
                    ...
                    <Button
                      ...
                      className="flex-1 h-10 py-4 rounded-xl bg-[#21479B] hover:bg-[#1a3778] text-white font-semibold text-sm transition-all hover:scale-[1.02] active:scale-95"
                    >
                    ...
                    <Button
                      onClick={() => router.push("/")}
                      variant="outline"
                      className="flex-1 py-4 h-10 rounded-xl border font-semibold text-sm hover:bg-muted transition-all hover:scale-[1.02] active:scale-95"
                    >
          ...
          <div className="lg:col-span-5 w-full space-y-4 order-2">
            {/* Donation Card */}
            <Card className="border-none shadow-md bg-[#21479B] text-white overflow-hidden relative group">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div className="flex-1 space-y-4 text-left">
                    ...
                    <Button
                      ...
                      className="w-full md:w-auto py-4 px-6 rounded-xl bg-white text-[#21479B] hover:bg-blue-50 font-semibold text-sm shadow-md transition-all hover:scale-[1.02] active:scale-95"
                    >
