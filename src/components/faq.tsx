...
const FAQSection = () => {
  const faqs = [
    ...
    {
      question: "Berapa biaya untuk mengunduh E-Book materi?",
      answer: "Semua materi E-Book dan simulasi soal di platform ini dapat diakses dan diunduh secara gratis sebagai bagian dari kampanye edukasi keselamatan berkendara."
    },
    {
